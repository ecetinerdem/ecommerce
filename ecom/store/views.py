...
def register_user(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.error(request, ("Whoops! Something went wrong while registering. Please try again!"))
...
def update_user(request):
    if request.user.is_authenticated:
        ...
        messages.error(request, "You must be logged in to access profile page!")        
        return redirect('home')
